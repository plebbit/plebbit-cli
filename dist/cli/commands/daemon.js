...
class Daemon extends core_1.Command {
    async run() {
        ...
        await (0, server_js_1.startRpcServer)(flags.plebbitRpcApiPort, `http://localhost:${flags.ipfsApiPort}/api/v0`, `http://localhost:${flags.ipfsGatewayPort}`, flags.plebbitDataPath, subsToSeed);
    }
}
